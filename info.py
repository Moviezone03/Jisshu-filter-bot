...
USERNAME = environ.get('USERNAME', "@the_user_isbusy") # ADMIN USERNAME
...
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mzoneoffl03:Movie@zone03@moviezone.lyi1y.mongodb.net/?retryWrites=true&w=majority&appName=Moviezone")
